/**
 * Centralized SVG icon components — all icons used across the app live
 * here as lightweight React components. Each accepts an optional className
 * for sizing/color overrides (defaults to "h-4 w-4").
 *
 * All icons are from Heroicons (20px solid). Using inline SVGs rather
 * than an icon library keeps the bundle small and avoids external deps.
 */
