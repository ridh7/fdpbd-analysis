...
class Settings(BaseSettings):
    ...
    # env_prefix means pydantic looks for FDPBD_CORS_ORIGINS in environment
    # variables. Without a prefix, it would look for CORS_ORIGINS which could
    # clash with other apps' env vars.
